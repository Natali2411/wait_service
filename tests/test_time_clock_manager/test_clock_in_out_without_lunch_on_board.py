...
class TestClockInOutWithOutLunchDashboard():
    """Test-case CRT-1343"""
    ...
    def test_clock_out(self, log_obj, login_obj, clock_obj):
        try:
            clock_obj.clock_out(login_obj=login_obj, password=config.password1, lunch=False, clock_out_lunch=False, is_login=False)
