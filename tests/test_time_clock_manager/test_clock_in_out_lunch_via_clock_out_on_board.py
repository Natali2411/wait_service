...
class TestClockInOutLunchViaClockOutDashboard():
    """Test-case CRT-1344"""
    ...
    def test_clock_out(self, log_obj, login_obj, clock_obj):
        try:
            clock_obj.clock_out(login_obj=login_obj, password=config.password1, lunch=True, clock_out_lunch=True, is_login=False)
