...
class TestClockInOutWithLunchDashboard():
    ...
    def test_user_clock_in_out_status1(self, clock_obj):
    ...
    def test_user_clock_in_out_status2(self, clock_obj):
    ...
    def test_user_clock_in_out_status3(self, clock_obj):
        clock_obj.check_user_clock_in_out_status(status="Clocked In", tm_type="ClockInOut")
    ...
    def test_user_clock_in_out_status4(self, clock_obj):
